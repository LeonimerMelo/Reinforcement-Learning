...
# print(env4.get_action_meanings())
...
if train_:
    ...
    torch.save(model.state_dict(), path + "model_DQN_Pong.pth")
    ...
    '''
    model = DQN(n_stack, n_actions)
    model.load_state_dict(torch.load(path + "model_DQN_Pong.pth", weights_only=True).to(device))
