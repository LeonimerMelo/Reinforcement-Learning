...
avaliable_epsodes = 5 # episódios na avaliação do modelo
...
if(is_training):
    ...
    for episode in range(episodes):
        ...
        while not done and not truncated:
            ...
            q_table[index_cart_pos, index_cart_vel, index_pole_angle, index_ang_vel, action] = q_table[index_cart_pos, index_cart_vel, index_pole_angle, index_ang_vel, action] + learning_rate_a * (
                reward + discount_factor_g * np.max(q_table[new_index_cart_pos, new_index_cart_vel, new_index_pole_angle, new_index_ang_vel,:]) - q_table[index_cart_pos, index_cart_vel, index_pole_angle, index_ang_vel, action]
            )
