...
# model = torch.load('ruta_al_modelo.pt', map_location=torch.device('cpu'))
...
path='/home/leo/python scripts/Atari Breakout DQN/'
#path = 'C:\\Leo\\python scripts\\Atari Breakout DQN\\'
path_model = path+'breakout_dqn_model_'+str(episodes)+'.pth'
...
# Treina o agente
#rewards, losses = agent.train(num_episodes=episodes, plot_interval=100)
...
try:
    ...
    # atualize o ambiente do agente existente
